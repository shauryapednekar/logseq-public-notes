...
- Multiplying a complex number $z$ by $i$ rotates $z$ by 90 degrees.
	...
	- A visual way of thinking about this is that $i$ is the transformation that takes the number 1 on the complex number plane to $i$, which preserves magnitude while moving the point counter clockwise by 90 degrees.
