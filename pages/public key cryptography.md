...
- **Public key encryption**
	...
	- Analogy: A public key is like a "custom lock" that can be attached to a message such that only the entity with access to the corresponding private key (the "custom key")
